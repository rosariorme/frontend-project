...
function pinit() {
	var pinimgurl="http://192.185.138.124/~emil/modul/media/images/07-imagina-tu-cocina/cocina/pequenia/Cocina_chica_Base.png";
...
<div id="menu_visualiza" class="menu" style="top:0px;position:absolute;z-index: 100;opacity:1;cursor:pointer; cursor: hand;font-family:'Lato' !important;font-weight:300; height:35px; padding-top:5px; font-size: 55 pt; color:#fff; background-color:rgba(0,0,0,0.5);">
    <ul>
        ...
        <!--<li style="vertical-align:middle;" id="flechita"></li>-->
        <li>
            <ul class="social">
...
<table border="0" cellspacing="0" cellpadding="0" style=" border-collapse:collapse;"> <!-- border-color:#fff; style="border-color:#fff;" -->
  <tr>
    ...
    <td><img class="hvr-grow" src="media/images/03-catalogo/cocinas/looks/acabados/amaderados/05-Almendra.jpg" width="40" height="40" onclick="javascript:ocultar_paleta5('05-Almendra.jpg')" onmouseover="mostrar_text_muestra5('05-Almendra')" style="border: 1px solid white;" /></td>
        <td><img class="hvr-grow" src="media/images/03-catalogo/cocinas/looks/acabados/amaderados/26-Cerezo.jpg" width="40" height="40" onclick="javascript:ocultar_paleta5('26-Cerezo.jpg')" onmouseover="mostrar_text_muestra5('26-Cerezo')" style="border: 1px solid white;" /></td>
  </tr>
  <tr>
    ...
    <td><img class="hvr-grow" src="media/images/03-catalogo/cocinas/looks/acabados/amaderados/10-Habano.jpg" width="40" height="40" onclick="javascript:ocultar_paleta5('10-Habano.jpg')" onmouseover="mostrar_text_muestra5('10-Habano')" style="border: 1px solid white;" /></td>
  ...
  <tr>
    ...
    <td><img class="hvr-grow" src="media/images/03-catalogo/cocinas/looks/acabados/amaderados/15-Nogal Americano.jpg" width="40" height="40" onclick="javascript:ocultar_paleta5('15-Nogal Americano.jpg')" onmouseover="mostrar_text_muestra5('15-Nogal Americano')" style="border: 1px solid white;" /></td>
...
<table border="0" cellspacing="0" cellpadding="0" style=" border-collapse:collapse;"> <!-- border-color:#fff; style="border-color:#fff;" -->
  <tr>
    <td><img class="hvr-grow" src="media/images/03-catalogo/cocinas/looks/acabados/lisos/pared1.jpg" width="40" height="40" onclick="javascript:ocultar_paleta('pared1.jpg')" onmouseover="mostrar_text_muestra('Blanco')" style="border: 1px solid white;" /></td>
    <td><img class="hvr-grow" src="media/images/03-catalogo/cocinas/looks/acabados/lisos/pared2.jpg" width="40" height="40" onclick="javascript:ocultar_paleta('pared2.jpg')" onmouseover="mostrar_text_muestra('Con diseño')" style="border: 1px solid white;" /></td>
